...
const HackerspaceModule: Module = {
    name: 'HackerspaceModule',
    ...
    commandHandlers: [
        {   // Returns info for the requested hackerspace
            commands: [ 'hackerspace' ],
            callback: async (msg, command) => {
                if (!command.args) {
...
export default HackerspaceModule;
